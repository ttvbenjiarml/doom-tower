...
namespace Doom
{
    ...
    public class Doom : ModTower
    {
        ...
        public override string Description => "Throws bombs at Bloons";
        ...
        public override void ModifyBaseTowerModel(TowerModel towerModel)
        {
            ...
            projectile.ApplyDisplay<DoomDisplay>(); // Make the projectiles look like Cards
            projectile.pierce += 2;
        }
